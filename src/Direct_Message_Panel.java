...
public class Direct_Message_Panel extends javax.swing.JPanel {
    public static JFrame SendMessage_Panel;
    ...
    public Direct_Message_Panel() {
        ...
        try {
            ...
            while (rs.next())
                ((DefaultTableModel)tbl_direct_message.getModel()).addRow(new Object[] {
    ...
    private void tbl_direct_messageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_direct_messageMouseClicked
        ...
        Profile_Panel.Direct_Message_JFrame.setVisible(false);
        SendMessage_Panel = create_JFrame(new SendMessage_Panel(Login_Panel.user_name, receiver), "Send Message Panel: " + Login_Panel.user_name, 300, 340);
        SendMessage_Panel.setVisible(true);
