...
public class UserPosts_Panel extends javax.swing.JPanel {
    ...
    public UserPosts_Panel(String user_name, String post, String date) {
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection connect = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/javagram_db", "root", "");
            String sql = "SELECT * FROM tbl_post WHERE user_name = ? AND post_txt = ? AND sharing_date = ?";
            PreparedStatement ps = connect.prepareStatement(sql);
            ps.setString(1, Pusername);
            ps.setString(2, Ppost);
            ps.setString(3, Pdate);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btn_send_cm, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btn_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_backActionPerformed
        ...
        Profile_Panel.UserPosts_Frame.setVisible(false);
    ...
    private void btn_likeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_likeActionPerformed
        if (btn_like.isSelected()) {
            try {
                ...
                // <editor-fold defaultstate="collapsed" desc="referesh panel">
                /*User_Panel.user_Posts_JFrame.setVisible(false);*/
                Profile_Panel.UserPosts_Frame.setVisible(false);
                Profile_Panel.UserPosts_Frame = create_JFrame(new UserPosts_Panel(Pusername, Ppost, Pdate), "User Post Panel: " + Login_Panel.user_name,  400, 670);
